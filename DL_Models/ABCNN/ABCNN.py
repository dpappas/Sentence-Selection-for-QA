...
class ABCNN():
    def __init__(self, s, w, l2_reg, model_type, num_features, d0=200, di=50, num_classes=2, num_layers=2):
        """
        ...
        # Create 4 placeholders for initialization in later stages
        # For question, answer, label and features respectively
        ...
        # Create window pooling function
